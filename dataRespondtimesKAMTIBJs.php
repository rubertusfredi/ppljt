...
if (isset($_GET["reservation"]) and $_GET["reservation"]<>"")
{
		...
		$sqlKejadian = "SELECT * FROM tb_sub_detail_laporan WHERE petugas='221E' and id_detail_laporan between '".$tgl1."' and '".$tgl2."' order by id_sub desc";
}
else
{
		$sqlKejadian = "SELECT * FROM tb_sub_detail_laporan WHERE petugas='221E' order by id_detail_laporan desc";
}
