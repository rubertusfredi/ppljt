 <title>MTRS-TMJ | Data Penderekan</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Data Penderekan 
        <small>Menampilkan Seluruh Data Penderekan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data Penderekan </li>
...
<!-- Horizontal Form -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Penderekan Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Seluruh Data Penderekan</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and type_kejadian ='MOGOK MESIN' and keterangan like '%gajah%'  order by tgl_detail_created desc LIMIT 100";
		  ...
		  <div id="print-me">			  
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Data Gangguan Kemanan Ketertiban </h4>
              </div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa fa-info-circle"></i> Detail Data Gangguan Kemanan Ketertiban 
