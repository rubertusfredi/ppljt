...
{ 
	if ($fgmembersite->getkmAwal($_GET['id']))
	{
	}
	else
	{
...
<!-- Content Header (Page header) -->
    ...
    <section class="content">	
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Pencatatan Kilometer Awal</h3>
		...
		<form class="form-horizontal" id="formKmAwal" action='<?php echo $fgmembersite->GetSelfScript(); ?>?mod=<?php echo $_GET["mod"]; ?>' method='post' accept-charset='UTF-8'>
		<input type="hidden" name="submitKmAwal" value="1" />
		<?php
		if((isset($_GET['st']))and($_GET['st']=="edit"))
		{ 
			?>
    ...
    <!------------------------------ LABEL KILOMETE ------------------------------------------->				
			...
			<div class="row">							
				<div class="col-sm-10 col-sm-offset-2">
					<h4 ><span class="label label-warning">KILOMETER AWAL</span></h4>
				</div>
			</div>			
    ...
    <!------------------------------ KILOMETER AWAL------------------------------------------->	
			...
			<div class="form-group <?php if (isset($error['awal_pik'])){echo 'has-error';} ?>">
				<label for="kmAwal212" class="col-sm-2 control-label">AWAL LJT212</label>
			<div class="col-sm-3">
			<div class="input-group input-group-sm ">
				<span class="input-group-addon"><i class="fa fa-tachometer"></i></span>
					<input type="text" class="form-control" name="kmAwal212" required="true" placeholder="Isi Kilometer Awal contoh 1000 km" value="<?php echo $fgmembersite->SafeDisplay('kmAwal212'); ?>">
				...
				<label for="kmAwal213" class="col-sm-2 control-label">AWAL LJT213</label>				
			<div class="col-sm-3">
			<div class="input-group input-group-sm ">
				<span class="input-group-addon"><i class="fa fa-tachometer"></i></span>
					<input type="text" class="form-control" name="kmAwal213" required="true" placeholder="Isi Kilometer Awal contoh 1000 km" value="<?php echo $fgmembersite->SafeDisplay('kmAwal213'); ?>">
				<!--<span class="input-group-btn">
					<button type="button" class="btn btn-info btn-flat">Kirim !</button>
				</span>
				-->
