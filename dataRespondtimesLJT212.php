...
<!-- Horizontal Form -->
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Seluruh Data Respond Times Petugas LJT212 Tahun <?php echo date("Y"); ?></h3>
	...
	<tbody>
	<?php 			
		$sqlKejadian = "SELECT * FROM tb_sub_detail_laporan WHERE petugas='LJT212' order by id_sub desc";
		...
		buttons: [ 
			{
				...
				filename: 'Data Respon Times LJT212<?php echo date("Ymd"); ?>'
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/dataRespondtimesLJT212Js.php?'+$( this ).serialize() ).load();
