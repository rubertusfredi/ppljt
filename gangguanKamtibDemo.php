<title>PPLJT | Data Gangguan Kamtib Orang Demo</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail
        <small>Data Gangguan Keamanan dan Ketertiban Orang Demo</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $fgmembersite->sitename; ?>?mod=gangguanKamtib">Data Gangguan Kamtib</a></li>
        <li class="active">Orang Demo</li>	
...
<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Orang Demo Masuk Tol Rentang Waktu Tertentu</h3>
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Data Kejadian Orang Demo Masuk Tol</h3>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Data Detail Gangguan Keamanan dan Ketertiban Orang Demo Masuk Tol</h4>
              </div>
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/gangguanKamtibDemoJs.php?'+$( this ).serialize() ).load();
