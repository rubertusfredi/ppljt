<title>PPLJT | Laporan Telpon Masuk Keperluan Memberi Informasi</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail Laporan
        <small>Telpon Masuk Keperluan Memberi Informasi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $fgmembersite->sitename; ?>?mod=LaporanTelpon">Laporan Telpon Masuk</a></li>
        <li class="active">Keperluan Memberi Informasi</li>		
...
<!-- Horizontal Form -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Telpon Masuk Memberi Informasi Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Telpon Masuk Memberi Informasi</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and keperluan='MEMBERI INFORMASI' and taruna_dari like 'TELPON%' order by tgl_detail_created desc";
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/TelponMemberiInformasiJs.php?'+$( this ).serialize() ).load();
