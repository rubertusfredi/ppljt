<title>PPLJT | Data Kejadian 3-3 (Kecelakaan)</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail 
        <small>Data Kejadian 3-3 (Kecelakaan)</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="index.php">Data Kejadian</a></li>
        <li class="active">3-3 (Kecelakaan)</li>		
...
<!-- Horizontal Form -->
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Kejadian 3-3 (Kecelakaan) Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Data Kejadian 3-3 (Kecelakaan)</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user, tb_detail_laporan b where a.id_laporan=b.id_laporan and type_kejadian='3-3' order by tgl_detail_created desc";
		...
		foreach($resKejadian as $outputkejadian => $valkejadian)
		{
			...
			$kashift = $valkejadian ["id_ka_shift"];
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-medkit"></i> Data 3-3 (Kecelakaan)
