...
<!-- Horizontal Form -->
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Seluruh Data Respond Times Petugas Rescue Tahun <?php echo date("Y"); ?></h3>
	...
	<tbody>
	<?php 			
		$sqlKejadian = "SELECT * FROM tb_sub_detail_laporan WHERE petugas='RESCUE' order by id_sub desc";
		...
		buttons: [ 
			{
				...
				filename: 'DataResponTimes<?php echo date("Ymd"); ?>'
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/dataRespondtimesRESCUEJs.php?'+$( this ).serialize() ).load();
