<title>PPLJT | Data Kejadian BAN</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail 
        <small>Data Kejadian Gangguan Pada BAN</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="index.php">Data Kejadian</a></li>
        <li class="active">Gangguan Pada BAN</li>		
...
<!-- Horizontal Form -->
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Kejadian Gangguan Pada BAN Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Data Kejadian Gangguan Pada BAN</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and type_kejadian='BAN' order by tgl_detail_created desc";
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Detail Data Kejadian 3-3 (Kecelakaan) </h4>
              </div>
		...
		buttons: [ 
			{
				...
				filename: 'DataKejadianBan<?php echo date("Ymd"); ?>'
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/dataKejadianBANJs.php?'+$( this ).serialize() ).load();
