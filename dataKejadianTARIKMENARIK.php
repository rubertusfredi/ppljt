<title>PPLJT | Data Tarik Menarik</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail 
        <small>Data Kejadian Tarik Menarik</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="index.php">Data Kejadian</a></li>
        <li class="active">Tarik Menarik</li>
...
<!-- Horizontal Form -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Kejadian Tarik Menarik Kendaraan Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Kejadian Tarik Menarik Kendaraan</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and type_kejadian='TARIK MENARIK' order by tgl_detail_created desc";
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Detail Data Tarik Menarik Kendaraan</h4>
              </div>
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/dataKejadianTarikJs.php?'+$( this ).serialize() ).load();
