<title>PPLJT | Data Gangguan Kamtib Penyebrag Jalan</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail
        <small>Data Gangguan Keamanan dan Ketertiban Penyebrag Jalan Masuk Tol</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $fgmembersite->sitename; ?>?mod=gangguanKamtib">Data Gangguan Kamtib</a></li>
        <li class="active">Penyebrag Jalan</li>	
...
<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Gangguan Penyebrag Jalan Masuk Tol Rentang Waktu Tertentu</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and kamtib='PENYEBRANG' order by tgl_detail_created desc";
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Data Detail Gangguan Keamanan dan Ketertiban Penyebrang Jalan Masuk Tol</h4>
              </div>
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/gangguanKamtibPenyebrangJs.php?'+$( this ).serialize() ).load();
