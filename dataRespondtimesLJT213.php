...
<!-- Horizontal Form -->
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Seluruh Data Respond Times Petugas LJT213 Tahun <?php echo date("Y"); ?></h3>
	...
	<tbody>
	<?php 			
		$sqlKejadian = "SELECT * FROM tb_sub_detail_laporan WHERE petugas='LJT213' order by id_sub desc";
	...
	?>
		...
		<tr>
			...
			<td class='text-center'>
				...
				<i class="fa fa-search fa-pull-left fa-border" aria-hidden="true">Lihat Detail</i>
				</a>
				</button>
		...
		buttons: [ 
			{
				...
				filename: 'Data Respon Times LJT213<?php echo date("Ymd"); ?>'
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/dataRespondtimesLJT213Js.php?'+$( this ).serialize() ).load();
