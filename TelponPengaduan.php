<title>PPLJT | Laporan Telpon Masuk Keperluan Pengaduan / Keluhan </title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail Laporan
        <small>Telpon Masuk Keperluan Pengaduan / Keluhan </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo $fgmembersite->sitename; ?>?mod=LaporanTelpon">Laporan Telpon Masuk</a></li>
        <li class="active">Keperluan Pengaduan / Keluhan </li>		
...
<!-- Horizontal Form -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Telpon Masuk Pengaduan / Keluhan  Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Telpon Masuk Pengaduan / Keluhan </h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and keperluan='PENGADUAN / KELUHAN' and taruna_dari like 'TELPON%' order by tgl_detail_created desc";
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/TelponPengaduanJs.php?'+$( this ).serialize() ).load();
