 <title>PPLJT | Form Kejadian</title>
<?PHP
...
$moduleDesc = "Menghimpun Data Informasi Kejadian ";
?>
...
<!-- Custom Tabs -->
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#tab_1" data-toggle="tab">Form Input Laporan Kejadian Tiap Shift</a></li>
			<li><a href="#tab_2" data-toggle="tab">Hasil Laporan Tiap Kejadian</a></li>
		</ul>
...
?>					
					...
					<!---------------------------- Sumber informasi dari tabel tb_sumber_info gan, dan di menu manager ditambahkan CRUD tabelnya ---------------------------->
						...
						<div class="form-group <?php if (isset($error['taruna_dari'])){echo 'has-error';} ?>">
							<label for="taruna_dari" class="col-sm-2 control-label">SUMBER INFO</label>
							<div class="col-sm-2">
	...
	<option <?php if($fgmembersite->SafeDisplay('taruna_dari')=="GT.JATINGALEH1") {echo "selected"; } ?> value="GT.JATINGALEH1">GT.JATINGALEH 1</option>	
	<option <?php if($fgmembersite->SafeDisplay('taruna_dari')=="GT.JATINGALEH2") {echo "selected"; } ?> value="GT.JATINGALEH2">GT.JATINGALEH 2</option>		
	...
	<option <?php if($fgmembersite->SafeDisplay('taruna_dari')=="RUAS LAIN") {echo "selected"; } ?> value="RUAS LAIN">RUAS LAIN</option>
...
<!---------------------------- KAMTIB dari tabel tb_kamtib gan, dan di menu manager ditambahkan CRUD tabelnya ---------------------------->
							...
							<label for="kamtib" class="col-sm-2 control-label">JENIS KAMTIB</label>
							<div class="col-sm-2">
								<div class="input-group">
									<div class="input-group-addon">
										<i class="fa fa-check-square"></i>
									</div>
									<select class="form-control" id="kamtib" name="kamtib">
<option value="">--</option>
<option <?php if($fgmembersite->SafeDisplay('kamtib')=="4-4") {echo "selected"; } ?> value="4-4">4-4 / ORANG GILA</option>
<option <?php if($fgmembersite->SafeDisplay('kamtib')=="BUS") {echo "selected"; } ?> value="BUS">BUS NAIK/TURUN PENUMPANG</option>
<option <?php if($fgmembersite->SafeDisplay('kamtib')=="JALAN BERLUBANG") {echo "selected"; } ?> value="JALAN BERLUBANG">JALAN BERLUBANG</option>
<option <?php if($fgmembersite->SafeDisplay('kamtib')=="OVER DIMENSI OVER LOAD") {echo "selected"; } ?> value="OVER DIMENSI OVER LOAD">OVER DIMENSI OVER LOAD</option>
						...
						<div class="form-group <?php if (isset($error['jenis_kendaraan'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="jenis_kendaraan" value="<?php echo $fgmembersite->SafeDisplay('jenis_kendaraan'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['nopol'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nopol" value="<?php echo $fgmembersite->SafeDisplay('nopol'); ?>">						
								</div>
				...
				<!---------------------------- WAKTU range antar jam ambil dari tabel tb_waktu gan, dan di menu manager ditambahkan CRUD tabelnya ---------------------------->						
						<div class="row">							
							<div class="col-sm-2 col-sm-offset-2">
								<h4 ><span class="label label-warning">WAKTU</span></h4>
							</div>
							<div class="col-sm-2 col-sm-offset-2">
								<h4 ><span class="label label-warning ">KEPERLUAN TELPON</span></h4>
							</div>						
						</div>	
...
<option <?php if($fgmembersite->SafeDisplay('keperluan')=="MEMINTA BANTUAN") {echo "selected"; } ?> value="MEMINTA BANTUAN">MEMINTA BANTUAN</option>
<option <?php if($fgmembersite->SafeDisplay('keperluan')=="MEMINTA INFORMASI") {echo "selected"; } ?> value="MEMINTA INFORMASI">MEMINTA INFORMASI</option>
...
<option <?php if($fgmembersite->SafeDisplay('keperluan')=="LAIN-LAIN") {echo "selected"; } ?> value="LAIN-LAIN">LAIN-LAIN</option>							
								...
								<?php if (isset($error['keperluan'])){echo '<i><small><span class="help-block">'.$error['keperluan'].'</span></small></i>';} ?>
											...
											<h4 ><span class="label label-default">Informasi Tambahan Keperluan hanya di isi apabila taruna dari TELPON PENGGUNA JALAN atau taruna dari TELPON RADIO RASIKA / ELSHINTA / IDOLA / RRI</span></h4>
						...
						<div class="form-group <?php if (isset($error['waktu1'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3 ">
								<div class="input-group bootstrap-timepicker ">
									...
									<input type="text" class="form-control timepicker " id="waktu1" name="waktu1" value="<?php echo $fgmembersite->SafeDisplay('waktu1'); ?>" >
                                <div class=""></div>									
								</div>
								<?php if (isset($error['waktu1'])){echo '<i><small><span class="help-block">'.$error['waktu1'].'</span></small></i>';} ?>
							</div>
											
							<!------------------  Fitur Sembunyikan Menu Cuaca ------------------->					
				                                <div id="cuaca"><div id="cuaca-show">
												
							<!------------------  Fitur Sembunyikan Menu Cuaca ------------------->	
							

							<label for="cuaca" class="col-sm-2 control-label">CUACA</label>
							<div class="col-sm-3">
								<div class="input-group">
									<div class="input-group-addon">
										<i class="fa fa-soundcloud"></i>
									</div>
									<select class="form-control" id="cuaca" name="cuaca">
										<option value="">--</option>
										<option <?php if($fgmembersite->SafeDisplay('cuaca')=="HUJAN") {echo "selected"; } ?> value="HUJAN">HUJAN</option>
										<option <?php if($fgmembersite->SafeDisplay('cuaca')=="CERAH") {echo "selected"; } ?> value="CERAH">CERAH</option>
									</select>
		                         	
								</div>
								<?php if (isset($error['cuaca'])){echo '<i><small><span class="help-block">'.$error['cuaca'].'</span></small></i>';} ?>
							</div>
						</div>
						</div>	
...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">
	<i class="fa fa-plus"></i> Tambah Petugas Bantuan
</button>
...
<thead>
	...
	<td align="center"><button type='button' class='btn bg-maroon  btn-flat'><i class='fa fa-trash'></i></button></td>
</tr>
<?php
$a++;
						/*
...
{	
	...
	$( "#timeKejadianForm" ).submit(function( event ) 
	{
		...
		no = table.data().count();
		//alert(no);
		//table.row.add( $('<tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td></tr>') ).draw();value="<?php echo $fgmembersite->SafeDisplay('waktu'); ?>"
		table.row.add( {
        "no":       (no + 1),
    ...
    background-color:#eee;
						...
						<div class="form-group <?php if (isset($error['33lb'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="33lb" value="<?php echo $fgmembersite->SafeDisplay('33lb'); ?>">						
								</div>
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="sarana" value="<?php echo $fgmembersite->SafeDisplay('sarana'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['33lr'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="33lr" value="<?php echo $fgmembersite->SafeDisplay('33lr'); ?>">						
								</div>
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="materi" value="<?php echo $fgmembersite->SafeDisplay('materi'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['33mg'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="33mg" value="<?php echo $fgmembersite->SafeDisplay('33mg'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['jenis_kendaraan1'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="jenis_kendaraan1" value="<?php echo $fgmembersite->SafeDisplay('jenis_kendaraan1'); ?>">						
								</div>
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nopol1" value="<?php echo $fgmembersite->SafeDisplay('nopol1'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['jenis_kendaraan2'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="jenis_kendaraan2" value="<?php echo $fgmembersite->SafeDisplay('jenis_kendaraan2'); ?>">						
								</div>
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nopol2" value="<?php echo $fgmembersite->SafeDisplay('nopol2'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['jenis_kendaraan3'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="jenis_kendaraan3" value="<?php echo $fgmembersite->SafeDisplay('jenis_kendaraan3'); ?>">						
								</div>
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nopol3" value="<?php echo $fgmembersite->SafeDisplay('nopol3'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['jenis_kendaraan4'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="jenis_kendaraan4" value="<?php echo $fgmembersite->SafeDisplay('jenis_kendaraan4'); ?>">						
								</div>
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nopol4" value="<?php echo $fgmembersite->SafeDisplay('nopol4'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['jenis_kendaraan5'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="jenis_kendaraan5" value="<?php echo $fgmembersite->SafeDisplay('jenis_kendaraan5'); ?>">						
								</div>
							...
							<div class="col-sm-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nopol5" value="<?php echo $fgmembersite->SafeDisplay('nopol5'); ?>">						
								</div>
						...
						<div class="form-group <?php if (isset($error['keterangan'])){echo 'has-error';} ?>">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<textarea class="form-control" rows="3" name="keterangan" placeholder="Keterangan ..."><?php echo $fgmembersite->SafeDisplay('keterangan'); ?></textarea>					
								</div>
		  ...
		  <div id="print-me">											
				<div class="box box-primary box-solid">
					...
					<img src="assets1/img/now-logo.png" width="150px" height="150px" alt="">							
					<style>
					th {
					...
					foreach($resh as $outputh)
					{
						...
						foreach($resd as $outputd)
						{
							...
							<tr>
								...
								if($outputd['taruna_dari']=="TIRTA"){ echo '<span class="label label-primary">'.$outputd['taruna_dari'].'</span>';}
								if($outputd['taruna_dari']=="TI"){ echo '<span class="label label-primary">'.$outputd['taruna_dari'].'</span>';}
								if($outputd['taruna_dari']=="JMTM"){ echo '<span class="label label-primary">'.$outputd['taruna_dari'].'</span>';}
							...
							if ($rowssub > 0)
							{
								...
								foreach($ressub as $outputdsub)
								{
									...
									<tr>
										...
										if($outputdsub['petugas']=="TIRTA"){ echo '<span class="label label-primary">'.$outputdsub['petugas'].'</span>';}
										if($outputdsub['petugas']=="TI"){ echo '<span class="label label-primary">'.$outputdsub['petugas'].'</span>';}
										if($outputdsub['petugas']=="JMTM"){ echo '<span class="label label-primary">'.$outputdsub['petugas'].'</span>';}
					...
					?>						
						...
						<button class="btn btn-app pull-right" id="xlsexport" onclick="printDiv('print-me')"> 
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><b>Kolom Tambah Petugas</b></h5>
...
<input type='hidden' name='submitted' id='submitted' value='1'/>
      <div class="modal-body">
		...
		<div class="form-group <?php if (isset($error['taruna_dari'])){echo 'has-error';} ?>">
			<label for="petugas" class="col-md-3 control-label"></label>
		...
		<div class="form-group <?php if (isset($error['t3'])){echo 'has-error';} ?>">
			...
			<div class="col-md-3">
				<div class="input-group bootstrap-timepicker timepicker">
					...
					<input type="text" disabled class="form-control timepicker " id="t3" name="t3" value="<?php echo $fgmembersite->SafeDisplay('t3'); ?>" style="z-index:1151 !important" >
				</div>
...
//Timepicker
	...
	$('#t2').on('change', function() 
	{
		...
		var timeOfCall = $('#t1').val(),
		timeOfResponse = $('#t2').val(),
