<title>PPLJT | Data Kejadian BBM</title>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Detail 
        <small>Data Kejadian Gangguan Bahan Bakar (BBM)</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="index.php">Data Kejadian</a></li>
        <li class="active">Gangguan Bahan Bakar</li>			
...
<!-- Horizontal Form -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Pencarian Data Kejadian Gangguan Bahan Bakar (BBM) Rentang Waktu Tertentu</h3>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Data Kejadian Gangguan Bahan Bakar (BBM)</h3>
	...
	<?php 
		...
		$sqlKejadian = "SELECT * FROM tb_laporan a left join tb_pegawai c on a.id_user=c.id_user , tb_detail_laporan b where a.id_laporan=b.id_laporan and type_kejadian='BBM' order by tgl_detail_created desc";
...
$("#idForm").submit(function(e) 
{
	...
	//var table = $('#tablesatu').DataTable();
	table.ajax.url( '<?php echo $fgmembersite->sitename; ?>/dataKejadianBBMJs.php?'+$( this ).serialize() ).load();
